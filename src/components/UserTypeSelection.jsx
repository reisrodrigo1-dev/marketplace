        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Crie e venda seus cursos jurídicos, monetize seu conhecimento e 
                construa sua autoridade no mercado.
              </p>
              ...
              <button
                onClick={() => navigate('/login-criador')}
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Encontre cursos jurídicos de qualidade, aprenda com especialistas 
                e desenvolva suas habilidades profissionais.
              </p>
